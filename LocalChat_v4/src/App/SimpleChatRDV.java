 ...
 * @author The Boss
 */
public class SimpleChatRDV extends javax.swing.JFrame {

    PeerGroup netPeerGroup = null;
    ChatService chatService;
    String name;
    NetworkManager netManager;
    public static int tcpPort = 9722;

    /**
     * Creates new form SimpleChat
     */
    public SimpleChatRDV() {
        System.out.println("loading class  SimpleChatRDV");
    ...
    private void startJxta() throws IOException {
        ...
        netManager = new NetworkManager(NetworkManager.ConfigMode.RENDEZVOUS_RELAY, name, ConfigurationFile.toURI());
        ...
        String seed = "tcp://" + InetAddress.getLocalHost().getHostAddress() + ":" + tcpPort;
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == btnSendMsg) {
                SimpleChatRDV.this.btnSendMsgActionPerformed(evt);
            }
            else if (evt.getSource() == btnAddCible) {
                SimpleChatRDV.this.btnAddCibleActionPerformed(evt);
            }
            else if (evt.getSource() == fldAddCible) {
                SimpleChatRDV.this.fldAddCibleActionPerformed(evt);
            }
        }
    ...
    private void btnAddCibleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddCibleActionPerformed
        ajouterCible();
    }//GEN-LAST:event_btnAddCibleActionPerformed

    private void fldAddCibleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fldAddCibleActionPerformed
        ajouterCible();
    }//GEN-LAST:event_fldAddCibleActionPerformed
